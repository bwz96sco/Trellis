...
class HarnessFixture(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.research = self.repo / ".trellis" / "tasks" / "c8-test" / "research"
        ...
        for filename in ("evaluation-plan.json", "run-record.schema.json", "runs.jsonl"):
...
class StaticEvidenceTests(HarnessFixture):
    ...
    def test_forward_identities_are_current_c8_and_production_resolved(self) -> None:
