...
class ClaudeRunnerTests(unittest.TestCase):
    ...
    def test_first_party_environment_removes_all_overrides_without_mutating_source(self) -> None:
        ...
        self.assertEqual(environment, {"PATH": "/usr/bin", "UNRELATED": "preserved"})
        self.assertTrue(all(key not in environment for key in runner.SANITIZED_ENVIRONMENT_KEYS))
    ...
    def test_first_party_environment_does_not_mutate_parent_environment(self) -> None:
        ...
        self.assertEqual(environment, {"PATH": "/bin", "PRESERVED": "yes"})
