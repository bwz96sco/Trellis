...
Core v2 reader precedes emitters. Registry/Procedure/policy land inactive. Commands precede Context gate. Context and both workers cut over together. Generation stops after host parity. Cleanup evidence precedes Skill source deletion. Packed negative audit and historical upgrade rehearsal precede parent closeout.
