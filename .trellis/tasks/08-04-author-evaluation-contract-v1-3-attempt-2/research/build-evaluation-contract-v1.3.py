...
SOURCE_DEFS = [
    ...
    ("SRC-OWNERSHIP", ".trellis/tasks/07-29-migrate-research-methodology-to-procedures/research/path-ownership-map.md", "376a8f7bf9d4559ea09a870383a133c576ebe7e69443a03523e883ffdde288f0", "text/markdown", "planning-preservation"),
...
"""
    ...
    attempt_binding = {
        ...
        "pathOwnership": {
            "authoringAllowlist": ".trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-2/**",
            "mustNotTouchAttempt1": True,
        },
        "priorAttemptDigests": {
            "candidateManifestSha256": ATTEMPT1_MANIFEST_DIGEST,
            "frozenMigrationTargetSha256": ATTEMPT1_TARGET_DIGEST,
            "mustDiffer": True,
        },
    ...
    manifest = {
        ...
        "digestGraph": {
            "acyclic": True,
            "excludedFromMembers": ["contract-candidate-manifest-v1.3.json", "contract-candidate-manifest-v1.3.sha256", "frozen-migration-target-v1.3.json", "frozen-migration-target-v1.3.sha256", "execution-evidence-ledger.json", "build-evaluation-contract-v1.3.py", "c0-preservation-attestation-v1.3.json", "author-accountability-v1.3-attempt-2.json", "author-accountability-v1.3-attempt-2.sha256", "c0-attempt-2-binding-attestation.json"],
    ...
    frozen_target = {
        ...
        "authorAccountability": {
            "filename": "author-accountability-v1.3-attempt-2.json",
            "required": True,
            "sha256": None,
        },
