# P2-09 implementation plan — Migrate computation and theory methodology
...
- `P2-05 accepted; P2-04 computation/theory slices available.` is satisfied with recorded evidence;
...
5. Execute the child-specific work:
   ...
   - Materialize the P2-01-frozen exact field contracts: artifact-lifecycle checkpoints for computation and ordered stages for theory.
   - Preserve assumptions, provenance, stable identifiers, uncertainty, claim strength, and cross-artifact consistency.
   - Run all four local field/lifecycle expansion cases and close `IMP-STAGE-FIELD-DEPTH` and `IMP-NON-PILOT-BEHAVIOR-DEPTH` for both packages.
