...
ATTEMPT = 3
P1_ANCESTOR_COMMIT = "692dc5130d3832a542808b390ca5b8c2a818996f"
P0_PRESERVATION_COMMIT = "867954ae7a201582fefcf26191e3733269cc9e39"
FAILED_COMPOUND_COMMIT = "4d36ecda5940b07a9611cf89089fe0bab7f3a54b"
EVIDENCE_BASELINE_COMMIT = "a198b4f35d7595bb31ad90913ef1c18c0e0015cb"
ATTEMPT1_MANIFEST_DIGEST = "4b8f6e507ac7239cc982bcd4941751af284c2e7425c4d65c9a6882b0bb431756"
ATTEMPT1_TARGET_DIGEST = "c9f95d33b8699b007d8e5e6c524b39201e4c3244f35c26d950d51dbdf5c9de4e"
ATTEMPT2_REJECTED_MANIFEST_DIGEST = "d8bc82e870d00593c738c7708528f99381e4d6b308bddf9256d5b4b99563e85f"
ATTEMPT2_REJECTED_TARGET_DIGEST = "76bf0a2402c8585e79499fdfdcc7afda2ff58d479c483fcf19f13e45d9318166"
A2_UNACCEPTED_COMMIT = "4c49b8fd0ae5525d24f1d8d1944571b9d62f610f"
Q1_CONTAINMENT_COMMIT = "5992826e"
A3_ACTIVATION_COMMIT = "3fb30fa8"
G0_GOVERNANCE_COMMIT = "a0ad27b0"
C0_MANIFEST_PATH = ".trellis/tasks/07-29-migrate-research-methodology-to-procedures/research/c0-v1.3-attempt-2-portable-preservation-manifest.json"
C0_PROCEDURE_LOCK_PATH = ".trellis/tasks/07-29-migrate-research-methodology-to-procedures/research/c0-v1.3-attempt-2-procedure-blob-lock.json"
C0_PROTECTED_LOCK_PATH = ".trellis/tasks/07-29-migrate-research-methodology-to-procedures/research/c0-v1.3-attempt-2-protected-evidence-blob-lock.json"
PROVENANCE_CLASSES = [
...
SOURCE_DEFS = [
    ...
    ("SRC-C0-ATTEMPT2-MANIFEST", ".trellis/tasks/07-29-migrate-research-methodology-to-procedures/research/c0-v1.3-attempt-2-portable-preservation-manifest.json", "2fdbd1feb2c6871e5a219c01c1b94f5cdfb4273ad5463099cb530e6600ae6fde", "application/json", "planning-preservation-attempt-2"),
    ("SRC-OWNERSHIP", ".trellis/tasks/07-29-migrate-research-methodology-to-procedures/research/path-ownership-map.md", "0f5c51b865620da75a70703432e2e7cbe7b5027fa76c501ac0a89cf9bde84001", "text/markdown", "planning-preservation"),
...
def build(output_dir: Path) -> list[str]:
    ...
    decisions.extend([
        ...
        decision("DEC-V13-LIFECYCLE-STABLE-ID", "Pattern variables are stable IDs with lowercase portable slug grammar and identity continuity.", common_gap, "Placeholder-backed outputs need explicit stable identity; exact paths use no extra stable ID.", ["random IDs", "position-derived IDs", "unvalidated free text"], "Future 2.0.4 only.", {"root": "full", "worker": "stable-id grammar"}, ["trellis.artifact.stable-id@1.0.0 critical"], ["stable", "base", "drift", "exact-path-inapplicable"]),
        decision("DEC-V13-LIFECYCLE-PROVENANCE", "Artifact provenance binds family, capability, Dispatch, Activation, Approval, Repository, ArtifactRef, and digest identities.", common_gap, "These existing control-plane identities provide deterministic provenance without copying private content.", ["free-form prose provenance", "worker-generated canonical IDs"], "Future 2.0.4 report/validation only; event schemas remain independent.", {"root": "full", "worker": "required public fields"}, ["trellis.artifact.provenance@1.0.0 critical"], ["complete", "base", "missing-or-drifted", "family-inapplicable"]),
...
Status: **candidate; non-authoritative; unaccepted; uncommitted; not activated; unavailable to runtime authority until MAL-1 B3 pass and operator OA3 accept**.
...
"""
    ...
    attempt_binding = {
        "attempt": ATTEMPT,
        "attemptLabel": "v13-a-attempt-3",
        "c0AncestorCommit": P1_ANCESTOR_COMMIT,
        "c0Locks": {
            "manifestPath": C0_MANIFEST_PATH,
            "manifestSha256": sha256_bytes((REPO_ROOT / C0_MANIFEST_PATH).read_bytes()),
            "procedureBlobLockPath": C0_PROCEDURE_LOCK_PATH,
            "procedureBlobLockSha256": sha256_bytes((REPO_ROOT / C0_PROCEDURE_LOCK_PATH).read_bytes()),
            "protectedEvidenceBlobLockPath": C0_PROTECTED_LOCK_PATH,
            "protectedEvidenceBlobLockSha256": sha256_bytes((REPO_ROOT / C0_PROTECTED_LOCK_PATH).read_bytes()),
            "procedureCount": 334,
            "protectedEvidenceCount": 412,
        },
        "evidenceBaselineCommit": EVIDENCE_BASELINE_COMMIT,
        "failedCompoundAuthoringCommit": FAILED_COMPOUND_COMMIT,
        "p0PreservationCommit": P0_PRESERVATION_COMMIT,
        "pathOwnership": {
            "authoringAllowlist": ".trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3/**",
            "mustNotTouchAttempt1": True,
        },
        "priorAttemptDigests": {
            "attempt1CandidateManifestSha256": ATTEMPT1_MANIFEST_DIGEST,
            "attempt1FrozenMigrationTargetSha256": ATTEMPT1_TARGET_DIGEST,
            "attempt2RejectedCandidateManifestSha256": ATTEMPT2_REJECTED_MANIFEST_DIGEST,
            "attempt2RejectedFrozenMigrationTargetSha256": ATTEMPT2_REJECTED_TARGET_DIGEST,
            "attempt2Role": "negative-comparison-only-not-semantic-authority-or-oracle",
            "mustDifferFromAttempt1": True,
            "mustDifferFromAttempt2": True,
        },
        "governanceCommits": {
            "a2UnacceptedCommit": A2_UNACCEPTED_COMMIT,
            "a3ActivationCommit": A3_ACTIVATION_COMMIT,
            "g0GovernanceCommit": G0_GOVERNANCE_COMMIT,
            "q1ContainmentCommit": Q1_CONTAINMENT_COMMIT,
        },
    ...
    manifest = {
        ...
        "digestGraph": {
            "acyclic": True,
            "excludedFromMembers": ["contract-candidate-manifest-v1.3.json", "contract-candidate-manifest-v1.3.sha256", "frozen-migration-target-v1.3.json", "frozen-migration-target-v1.3.sha256", "execution-evidence-ledger.json", "build-evaluation-contract-v1.3.py", "c0-preservation-attestation-v1.3.json", "author-accountability-v1.3-attempt-3.json", "author-accountability-v1.3-attempt-3.sha256", "c0-attempt-3-binding-attestation.json"],
    ...
    compatibility = normative({
        ...
        "procedureVersions": {
            ...
            "2.0.3": {"activationAuthorized": False, "authoritative": False, "disposition": "historical-unaccepted-development-evidence-bytes-preserved", "runtimeAuthority": False},
            "2.0.4": {"activationAuthorized": False, "futureBinding": "exact-v13-identity-and-digest-after-mal1-b3-pass-and-oa3-accept"},
    ...
    frozen_target = {
        ...
        "authorAccountability": {
            "filename": "author-accountability-v1.3-attempt-3.json",
            "required": True,
            "sha256": None,
        },
        "authoringCommit": None,
        "candidateManifest": {"filename": "contract-candidate-manifest-v1.3.json", "sha256": manifest_digest},
        "candidateStatus": normative({"accepted": False, "activated": False, "authoritative": False, "availableToRuntimeAuthority": False, "availableToR2A": False, "mal1Required": True, "humanReviewed": False, "committed": False, "reviewerIdentity": None, "status": "candidate", "v13BPassed": False, "mal1B3Passed": False, "oa3Accepted": False}, "trellis-native-v1.3", "DEC-V13-CANDIDATE-AUTHORITY"),
...
def verify(output_dir: Path, *, verify_execution_evidence: bool = False) -> dict[str, Any]:
    ...
    if verify_execution_evidence:
        ...
        if attestation["reproduction"] != expected_c0_reproduction or c0["protectedEvidenceGroupCounts"] != [408, 5, 1]:
        ...
        expected_commands = {
            "CMD-DIFF-CHECK": (["git", "diff", "--check", "--", ".trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3"], {"OWNED-DIFF-CHECK"}),
            "CMD-GENERATE-VERIFY": (["uv", "run", "python", "./.trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3/research/build-evaluation-contract-v1.3.py"], {"GENERATED-CANDIDATE", "SEMANTIC-VERIFY-PASSED"}),
            "CMD-INDEPENDENT-REBUILD": (["uv", "run", "python", "./.trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3/research/build-evaluation-contract-v1.3.py", "--check-rebuild"], {"SECOND-MUTATION-SUITE", "SECOND-REBUILD"}),
            "CMD-PROTECTED-INVENTORIES": (["uv", "run", "python", "./.trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3/research/build-evaluation-contract-v1.3.py", "--check-protected"], {"C0-EVIDENCE-AGGREGATE", "C0-PROCEDURE-AGGREGATE", "EVIDENCE-412", "PROCEDURE-334"}),
            "CMD-VALIDATE-CHILD": (["uv", "run", "python", "./.trellis/scripts/task.py", "validate", "./.trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3"], {"CHILD-TASK-VALID"}),
            ...
            "CMD-VERIFY-ONLY": (["uv", "run", "python", "./.trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3/research/build-evaluation-contract-v1.3.py", "--verify-only"], {"INDEPENDENT-REBUILD", "STRICT-MUTATIONS-REJECTED"}),
        }
        ...
        if deterministic.get("digestsDifferFromAttempt1") is not True:
            raise ValueError("attempt-3 digests must differ from attempt-1")
        if deterministic.get("digestsDifferFromAttempt2") is not True:
            raise ValueError("attempt-3 digests must differ from rejected attempt-2")
        if deterministic.get("manifestDigest") in {
            ATTEMPT1_MANIFEST_DIGEST,
            ATTEMPT2_REJECTED_MANIFEST_DIGEST,
        } or deterministic.get("targetDigest") in {
            ATTEMPT1_TARGET_DIGEST,
            ATTEMPT2_REJECTED_TARGET_DIGEST,
        }:
            raise ValueError("attempt-3 digests collided with prior attempt digests")
        expected_authority = {
        ...
        expected_preservation_claims = {
            ...
            "c0PreservationAttestation": ".trellis/tasks/08-04-author-evaluation-contract-v1-3-attempt-3/research/c0-preservation-attestation-v1.3.json",
            "c0ProcedureHashInventorySha256": "67aa0f50f157859e6747ee7f8cbfbe45ed1b236461f3d7095d8672e694f2d7a5",
            "c0ProtectedEvidenceHashInventorySha256": "506ff75c24e6701d829b2474b6ed9e311a9b5ada7860bc0abc8cf2c0d0a01c20",
            ...
            "localCanonicalProtectedEvidenceInventorySha256After": "edf24c80ec4177ab929902260c3baf873e1a63c3be62c052b54555953ee8944f",
            "localCanonicalProtectedEvidenceInventorySha256Before": "edf24c80ec4177ab929902260c3baf873e1a63c3be62c052b54555953ee8944f",
            "protectedEvidenceFileCount": 414,
    ...
    if manifest_digest in {ATTEMPT1_MANIFEST_DIGEST, ATTEMPT2_REJECTED_MANIFEST_DIGEST}:
        raise ValueError("manifest digest collides with prior attempt")
    if target_digest in {ATTEMPT1_TARGET_DIGEST, ATTEMPT2_REJECTED_TARGET_DIGEST}:
        raise ValueError("target digest collides with prior attempt")
    return {
        "bindingCount": len(bindings),
        "blockedOutputCount": sum(row["disposition"]["value"] == "blocked-by-contract" for row in disposition["outputs"]),
        "closureFamilyCount": len(closure["families"]),
...
def check_protected_inventories() -> dict[str, Any]:
    ...
    # Live protected evidence is 414: C0 baseline 412 + two post-C0 historical
    # unaccepted 2.0.3 cutover sidecars under activate research (bytes preserved; not authority).
    expected_evidence = (414, "edf24c80ec4177ab929902260c3baf873e1a63c3be62c052b54555953ee8944f")
    ...
    expected_c0 = {
        ...
        "protectedEvidenceCount": 414,
        "protectedEvidenceGroupCounts": [408, 5, 1],
        "protectedEvidenceSha256": "506ff75c24e6701d829b2474b6ed9e311a9b5ada7860bc0abc8cf2c0d0a01c20",
    }
    if c0 != expected_c0:
        raise ValueError(f"parent C0 preservation inventory drift: {c0}")
    # Portable C0 lock files at 692dc513 remain byte-identical (separate from live inventory growth).
    portable_manifest = REPO_ROOT / C0_MANIFEST_PATH
    portable_manifest_sha = sha256_bytes(portable_manifest.read_bytes())
    if portable_manifest_sha != "2fdbd1feb2c6871e5a219c01c1b94f5cdfb4273ad5463099cb530e6600ae6fde":
        raise ValueError(f"portable C0 manifest lock drift: {portable_manifest_sha}")
    return {
