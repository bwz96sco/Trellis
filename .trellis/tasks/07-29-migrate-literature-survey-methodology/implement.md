# P2-07 implementation plan — Migrate literature and survey methodology
...
- `P2-05 accepted; P2-04 literature/survey slice available.` is satisfied with recorded evidence;
...
1. Deepen literature discovery/review stages and durable evidence/provenance contracts.
2. Add survey as an explicit non-default synthesis workflow that does not take discovery ownership from literature.
3. Separate source facts, citations, synthesis, uncertainty, selected/blocked closure, and root Decisions.
4. Represent unavailable external integrations as explicit blocked/partial/inconclusive outcomes, never silent success.
5. Resolve medium-confidence field depth through Trellis-native observable-methodology extraction.
...
Remove/revert only dormant literature/survey versions, family validators, fixtures, and family spec.
