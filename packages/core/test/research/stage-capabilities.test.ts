...
const EXPECTED_CAPABILITIES = [
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "project-setup-v1", version: "2.0.1" },
  ...
  },
  {
    ...
    procedure: { id: "quest-framing-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "quest-admin-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "automatic",
    procedure: { id: "literature-review-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
  ...
  },
  {
    ...
    kind: "bounded",
    activation: "explicit",
    procedure: { id: "literature-scan-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "survey-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
  ...
  },
  {
    ...
    kind: "bounded",
    activation: "automatic",
    procedure: { id: "idea-generation-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "idea-evaluation-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
  ...
  },
  {
    ...
    kind: "bounded",
    activation: "automatic",
    procedure: { id: "experiment-round-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "experiment-campaign-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "declared-only",
    repositoryScope: "multiple",
  ...
  },
  {
    ...
    kind: "bounded",
    activation: "automatic",
    procedure: { id: "computation-case-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "bounded",
    activation: "automatic",
    procedure: { id: "theory-case-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "bounded",
    activation: "automatic",
    procedure: { id: "review-case-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "review-campaign-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "multiple",
    maxDurationMinutes: 60,
  ...
  },
  {
    ...
    kind: "bounded",
    activation: "automatic",
    procedure: { id: "writing-case-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 15,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "figure-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 30,
  ...
  },
  {
    ...
    kind: "workflow",
    activation: "explicit",
    procedure: { id: "slides-v1", version: "2.0.1" },
    workerAuthority: "proposal-only",
    networkPolicy: "forbidden",
    repositoryScope: "single",
    maxDurationMinutes: 30,
...
describe("resolveResearchCapability", () => {
  ...
  it("allows the alternate non-default literature capability for a matching stage", () => {
    expect(
      resolveResearchCapability({
        stage: "literature",
