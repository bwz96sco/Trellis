---
name: trellis-research-literature
description: Collect, compare, and cite relevant sources for the literature stage. Use only for explicit research intent or dispatch.
stage: literature
---

# Trellis Research Literature

Own only the `literature` stage of an active research Quest.
...
- Gather only sources relevant to the declared objective and acceptance criteria.
- Preserve citations, provenance, conflicts, and evidence gaps in bounded outputs.
