# experiment-round-v1 methodology (v2)

## Purpose

Trellis-native methodology package for `experiment-round-v1` migrated under Phase-2 from frozen evaluation-contract-v1.2.0 contracts.
...
1. **01-plan** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
2. **02-run** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
3. **03-observe** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
4. **04-claim-bound** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
