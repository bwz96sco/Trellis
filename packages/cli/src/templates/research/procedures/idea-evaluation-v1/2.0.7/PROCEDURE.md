# idea-evaluation-v1 methodology (v2.0.7)

## Purpose

Dormant Procedure package for `idea-evaluation-v1`, projected from the exact accepted `evaluation-contract-v1.3.1` semantics.

## Exact mapping

- Capability: `research.ideation.evaluate`
- Lifecycle disposition: `applicable`
- Artifact family: `research-idea-evaluation`
