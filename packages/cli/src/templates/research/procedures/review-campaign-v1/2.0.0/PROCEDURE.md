# review-campaign-v1 methodology (v2)

## Purpose

Trellis-native methodology package for `review-campaign-v1` migrated under Phase-2 from frozen evaluation-contract-v1.2.0 contracts.
...
1. **01-scope** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
2. **02-case-bind** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
3. **03-roll-up** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
