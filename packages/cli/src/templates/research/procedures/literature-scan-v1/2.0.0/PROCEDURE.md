# literature-scan-v1 methodology (v2)

## Purpose

Trellis-native methodology package for `literature-scan-v1` migrated under Phase-2 from frozen evaluation-contract-v1.2.0 contracts.
...
1. **01-query** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
2. **02-collect** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
