# project-setup-v1 methodology (v2)

## Purpose

Trellis-native methodology package for `project-setup-v1` migrated under Phase-2 from frozen evaluation-contract-v1.2.0 contracts.
...
2. **02-workspace** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
3. **03-constraints** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
