# writing-case-v1 methodology (v2)

## Purpose

Trellis-native methodology package for `writing-case-v1` migrated under Phase-2 from frozen evaluation-contract-v1.2.0 contracts.
...
1. **01-outline** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
2. **02-draft** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
3. **03-evidence-bind** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
