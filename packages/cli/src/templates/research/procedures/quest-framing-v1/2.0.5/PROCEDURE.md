# quest-framing-v1 methodology (v2.0.5 repair)

## Purpose

Trellis-native repaired methodology package for `quest-framing-v1` under evaluation-contract-v1.2.0.
...
2. **02-decision-target** — complete with declared inputs/outputs; fail closed on missing critical evidence.
