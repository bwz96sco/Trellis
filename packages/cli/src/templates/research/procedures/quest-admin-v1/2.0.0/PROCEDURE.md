# quest-admin-v1 methodology (v2)

## Purpose

Trellis-native methodology package for `quest-admin-v1` migrated under Phase-2 from frozen evaluation-contract-v1.2.0 contracts.
...
1. **01-plan-change** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
2. **02-apply-event** — complete checkpoint with declared inputs/outputs and fail closed on missing critical evidence.
