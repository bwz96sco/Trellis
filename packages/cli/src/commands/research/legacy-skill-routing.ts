...
export type LegacyResearchCapability =
  | "research.setup"
  | "research.framing"
  | "research.literature"
  | "research.ideation"
...
export type LegacyOptionalResearchSkill =
...
export type LegacyBundledResearchSkill =
...
export type LegacyResearchStageCapabilityDefinition =
  | {
      readonly dispatchable: true;
      readonly capability: LegacyResearchCapability;
      readonly optionalSkill: LegacyOptionalResearchSkill;
      readonly fallbackSkill: LegacyBundledResearchSkill;
    }
  | {
...
export const RESEARCH_STAGE_CAPABILITIES = {
  ...
  Record<QuestStage, LegacyResearchStageCapabilityDefinition>
>;
...
export type ResearchStageCapabilityResolution =
  | {
      readonly stage: Exclude<QuestStage, "complete">;
      readonly host: ResearchExecutionHost;
      readonly dispatchable: true;
      readonly capability: LegacyResearchCapability;
      readonly optionalSkill: LegacyOptionalResearchSkill;
      ...
      readonly selectedSkill:
        | LegacyOptionalResearchSkill
        | LegacyBundledResearchSkill;
